...
VOLUMES = {
    "1gb":       {"name": "1GB",       "price_1m": 10000,  "price_3m": 15000},
    "5gb":       {"name": "5GB",       "price_1m": 50000,  "price_3m": 75000},
    "100gb":     {"name": "100GB",     "price_1m": 100000, "price_3m": 150000},
    "200gb":     {"name": "200GB",     "price_1m": 200000, "price_3m": 300000},
    "unlimited": {"name": "Unlimited", "price_1m": 500000, "price_3m": 750000},
}
...
async def keyboard_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "🛒 خرید VPN":
        ...
        keyboard = [[InlineKeyboardButton(str(a) + " تومان", callback_data="topup_amount_" + str(a))] for a in amounts]
        keyboard.append([InlineKeyboardButton("🔙 برگشت", callback_data="back_main")])
        ...
        await update.message.reply_text(
            ...
            "💰 درآمد از دعوت: " + str(earnings) + " تومان\n\n"
            "📌 قوانین:\n"
...
async def admin_approve(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if row:
        ...
        try:
            ...
            pass
        await update.message.reply_text("✅ سفارش #" + str(oid) + " تایید شد و کاربر " + str(user_id) + " مطلع شد.")
...
def main():
    ...
    KEYBOARD_BUTTONS = "^(🛒 خرید VPN|🎁 تست رایگان|💰 افزایش موجودی|👥 دعوت از دوستان|👤 حساب من|📋 اشتراک های من|📞 پشتیبانی)$"
